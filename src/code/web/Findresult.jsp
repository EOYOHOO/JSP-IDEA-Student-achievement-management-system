...
<%
    ...
    try
    {
        ...
        if(!rs.next())
        {
            ...
            %>
<center><a href="../../out/artifacts/untitled11_war_exploded/teacharMenu.jsp" class="btn btn-info" role="button">返回主页</a></center>
<%
        }else{
        %>
...
<form name="form1" method="post" >
    <table class="table table-condensed table-hover" >
        ...
        <tr>
            ...
            <a href="Findinfo1.jsp" class="btn btn-info" role="button">返回</a>
        </tr>
    </table>
</form>
<%}
